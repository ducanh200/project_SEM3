...
function Info(){
    return(
        ...
        <div class="greennature-color-wrapper  gdlr-show-all greennature-skin-service-half greennature-half-bg-wrapper" style={{backgroundColor: "#f5f5f5", paddingBottom: "20px"}}>
            <div class="greennature-half-bg greennature-bg-solid" style={{backgroundImage: "url(upload/shutterstock_133689230.jpg)"}}></div>
            <div class="container">
