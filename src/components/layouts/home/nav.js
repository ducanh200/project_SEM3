...
function Nav(){
    return(
        <section id="content-section-3">
                        <div class="greennature-parallax-wrapper greennature-background-image gdlr-show-all no-skin" id="greennature-parallax-wrapper-1" data-bgspeed="0.11" style={{backgroundImage: "url('upload/donation-bg.jpg')", paddingTop: "90px", paddingBottom: "65px"}}>
                            <div class="container">
                                <div class="six columns">
                                    <div class="greennature-item greennature-action-ads-item" style={{background: "url('upload/donation-bg-1.jpg')"}}>
                                        ...
                                        <div class="action-ads-content">
                                            ...
                                            <a class="action-ads-button large greennature-button greennature-lb-payment" href="#" style={{color: "#6d5b1c",backgroundColor: "#fec428"}}>Donate Now</a></div>
                                    </div>
                                </div>
                                <div class="six columns">
                                    <div class="greennature-item greennature-action-ads-item" style={{background: "url('upload/donation-bg-2.jpg')"}}>
                                        ...
                                        <div class="action-ads-content">
                                            ...
                                            <a class="action-ads-button large greennature-button" style={{color: "#ffffff",backgroundColor: "#5dc269"}} href="#">Act Now!</a></div>
                                    </div>
                                </div>
                                <div class="clear"></div>
                            </div>
