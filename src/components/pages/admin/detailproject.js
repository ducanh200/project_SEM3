    ...
    return(
        <LayoutAdmin>
              ...
              <div className="ui segment cards">
                ...
                <NavLink to={`/admin/editproject/${project.id}`}><a href="" className="btn btn-primary">Edit</a></NavLink>

                <a style={{marginLeft:"30px"}} className="btn btn-primary" onClick={() => handleDelete(project.id)}>Delete</a>
