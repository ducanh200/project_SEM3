        ...
        <LayoutStaff>
                        ...
                        <div className="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active" aria-current="page">Edit a Topic</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div className="card-bory">
                ...
                <div class="form-group"  >
                    <h2 style={{textAlign: "center", marginTop: "15px"}}>Edit A Topic</h2>
                </div>
...
export default Staff_edittopic;