                                        ...
                                        <div className="portfolio-item-wrapper type-classic-portfolio" data-ajax="https://demo.goodlayers.com/greennature/wp-admin/admin-ajax.php">
                                            ...
                                            <div className="portfolio-item-holder  greennature-portfolio-column-2">
                                                <div className="greennature-isotope filter-container" data-type="portfolio" data-layout="masonry">
                                                            ...
                                                            <div className="greennature-ux greennature-classic-portfolio-ux">
                                                                ...
                                                                <div className="portfolio-classic-content">
                                                                    ...
                                                                    <div className="greennature-portfolio-info">
                                                                        <div className="portfolio-info portfolio-tag"><span className="info-head greennature-title">Tags </span><a href="#" rel="tag">Environment</a><span className="sep">,</span> <a href="#" rel="tag">Renewable Energy</a></div>
                                                                        <div className="clear"></div>
                                                                    </div>
                                                    ...
                                                    <div className="six columns class2">
                                                        <div className="greennature-item greennature-portfolio-item greennature-classic-portfolio">
                                                            <div className="greennature-ux greennature-classic-portfolio-ux">
                                                                ...
                                                                <div className="portfolio-classic-content">
                                                                    ...
                                                                    <div className="greennature-portfolio-info">
                                                                        <div className="portfolio-info portfolio-tag"><span className="info-head greennature-title">Tags </span><a href="#" rel="tag">African</a><span className="sep">,</span> <a href="#" rel="tag">Animals</a></div>
                                                                        <div className="clear"></div>
                                                                    </div>
                                                                    <div className="portfolio-excerpt">Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Vivamus sagittis...
                                                                        <div className="clear"></div><a href="#" className="excerpt-read-more">Read More</a></div><a className="portfolio-classic-learn-more" href="#">Learn More</a></div>
                                                    ...
                                                    <div className="clear"></div>
                                                    <div className="six columns class3">
                                                        <div className="greennature-item greennature-portfolio-item greennature-classic-portfolio">
                                                            <div className="greennature-ux greennature-classic-portfolio-ux">
                                                                <div className="portfolio-thumbnail greennature-image"><img src="upload/shutterstock_53600221-400x300.jpg" alt="" width="400" height="300" /><span className="portfolio-overlay">&nbsp;</span><a className="portfolio-overlay-icon" href="https://vimeo.com/101707505" data-rel="fancybox" data-fancybox-type="iframe"><span className="portfolio-icon" ><i className="fa fa-film" ></i></span></a></div>
                                                                <div className="portfolio-classic-content">
                                                    ...
                                                    <div className="six columns class1">
                                                        <div className="greennature-item greennature-portfolio-item greennature-classic-portfolio">
                                                            <div className="greennature-ux greennature-classic-portfolio-ux">
                                                                <div className="portfolio-thumbnail greennature-image"><img src="upload/shutterstock_124871620-400x300.jpg" alt="" width="400" height="300" /><span className="portfolio-overlay">&nbsp;</span><a className="portfolio-overlay-icon" href="#"><span className="portfolio-icon" ><i className="fa fa-link" ></i></span></a></div>
                                                                <div className="portfolio-classic-content">
                                                    ...
                                                    <div className="six columns class2">
                                                        <div className="greennature-item greennature-portfolio-item greennature-classic-portfolio">
                                                            <div className="greennature-ux greennature-classic-portfolio-ux">
                                                                <div className="portfolio-thumbnail greennature-image"><img src="upload/shutterstock_281995004-400x300.jpg" alt="" width="400" height="300" /><span className="portfolio-overlay">&nbsp;</span><a className="portfolio-overlay-icon" href="#"><span className="portfolio-icon" ><i className="fa fa-link" ></i></span></a></div>
                                                                <div className="portfolio-classic-content">
                                                                    <h3 className="portfolio-title"><a  href="#"  >Video inside this post</a></h3>
                                                                    <div className="greennature-portfolio-info">
                                                                        <div className="portfolio-info portfolio-tag"><span className="info-head greennature-title">Tags </span><a href="#" rel="tag">Earth</a><span className="sep">,</span> <a href="#" rel="tag">Environment</a></div>
                                                                        <div className="clear"></div>
                                                                    </div>
                                                                    <div className="portfolio-excerpt">Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Vivamus sagittis...
                                                                        <div className="clear"></div><a href="#" className="excerpt-read-more">Read More</a></div><a className="portfolio-classic-learn-more" href="#">Learn More</a></div>
                                                    ...
                                                    <div className="six columns class3">
                                                        <div className="greennature-item greennature-portfolio-item greennature-classic-portfolio">
                                                            <div className="greennature-ux greennature-classic-portfolio-ux">
                                                                <div className="portfolio-thumbnail greennature-image"><img src="upload/shutterstock_256181956-400x300.jpg" alt="" width="400" height="300" /><span className="portfolio-overlay">&nbsp;</span><a className="portfolio-overlay-icon" href="upload/shutterstock_256181956.jpg" data-rel="fancybox"><span className="portfolio-icon" ><i className="fa fa-search" ></i></span></a></div>
                                                                <div className="portfolio-classic-content">
                                                                    <h3 className="portfolio-title"><a  href="#"  >Kids Can Volunteer</a></h3>
                                                                    <div className="greennature-portfolio-info">
                                                                        <div className="portfolio-info portfolio-tag"><span className="info-head greennature-title">Tags </span><a href="#" rel="tag">Donation</a><span className="sep">,</span> <a href="#" rel="tag">Volunteer</a></div>
                                                                        <div className="clear"></div>
                                                                    </div>
                                                                    <div className="portfolio-excerpt">Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Vivamus sagittis...
                                                                        <div className="clear"></div><a href="#" className="excerpt-read-more">Read More</a></div><a className="portfolio-classic-learn-more" href="#">Learn More</a></div>
